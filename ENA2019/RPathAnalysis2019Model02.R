...
data02 <- read_csv("https://public.minsky.cc/maria/market_channel_factors_db/model/2019_02ModelDataframeOfWhitePotato.csv")

model02 <- "# direct effect
            ...
            # mediation throught market size
              ...
              i_1a := a1a*b1
              i_1b := a1b*b1
            # mediation throught simplified market channel directedness
              i_20 := a20*b2
              i_21 := a21*b2
              i_23 := a23*b2
              i_24 := a24*b2
...
fit02 <- sem(model02, data = data02, estimator="WLSM")
